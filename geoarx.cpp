...
//-----------------------------------------------------------------------------
//- geoarx.cpp : Initialization functions
//-----------------------------------------------------------------------------
#include "StdAfx.h"
#include "resource.h"
...
AC_IMPLEMENT_EXTENSION_MODULE(geoarxDLL)
...
#ifdef NEVER
AFX_EXTENSION_MODULE AsyncCommandDemoExtDLL ={ NULL, NULL } ;
#endif
...
BOOL WINAPI DllMain (HINSTANCE hInstance, DWORD dwReason, LPVOID lpReserved) {
	...
	if ( dwReason == DLL_PROCESS_ATTACH ) {
		...
		geoarxDLL.AttachInstance (hInstance) ;
		InitAcUiDLL () ;
      g_hInst = hInstance;
	} else if ( dwReason == DLL_PROCESS_DETACH ) {
		geoarxDLL.DetachInstance () ;
	}
	return (TRUE) ;
}
